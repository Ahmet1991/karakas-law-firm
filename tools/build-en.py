...
s += ('<main>\n'
  ...
  '</div></div></section>\n'
  '<section class="founder" aria-labelledby="founder-title"><div class="shell founder__grid">'
  '<figure class="founder__portrait reveal">'
  '<img src="../../assets/pinar-karakas-portre.webp" alt="Att. Pınar Karakaş" width="900" height="883" '
  'loading="lazy"></figure>'
